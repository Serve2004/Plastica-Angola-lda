...
export function Footer() {
  return (
    <div className="flex flex-col items-center justify-center px-4 md:px-8 xl:px-10 py-14.5 md:py-2.25 gap-6 bg-[#343434]">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full pb-20 pt-5 border-b border-[#6C6B6B80]">
        <div className="flex flex-col items-start gap-1 overflow-hidden">
          <div className="flex items-center justify-center w-25 md:w-35">
            <img src={assets.footer} alt="Footer Logo" />
          </div>
          <p className="text-[#E9E2E2E5] text-[15px] w-full max-w-xs">
      ...
      <div className="flex flex-col md:flex-row md:justify-between items-center w-full md:items-start gap-4">
        <div className="flex flex-col">
