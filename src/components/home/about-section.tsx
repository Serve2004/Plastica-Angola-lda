    ...
    >
      <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 sm:gap-6">
        <div className="flex-1 max-w-136.5">
          ...
          <p className="montserrat-medium text-[11px] sm:text-xs md:text-sm lg:text-[17px] text-[#777777] mt-2 text-justify">
          ...
          <p className="montserrat-medium text-[11px] sm:text-xs md:text-sm lg:text-[17px] text-[#777777] mt-3 sm:mt-5 text-justify">
